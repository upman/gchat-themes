...
const darkTheme: Theme = {
    ...
    inlineMarkdown: 'rgb(245, 245, 245)',
    multilineMarkdown: 'rgb(239, 239, 239)',
    ...
    threadBorder: 'rgb(83, 102, 115)',
    multiLineMarkdownBorder: 'rgb(71, 110, 146)',
