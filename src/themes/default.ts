...
const defaultTheme: Theme = {
    ...
    inlineMarkdown: 'rgb(231, 232, 235)',
    multilineMarkdown: 'rgb(66, 66, 66)',
    ...
    threadBorder: 'rgb(218, 220, 224)',
    multiLineMarkdownBorder: 'rgb(224, 224, 224)',
